...
const ExpenseTracker = () => {
  ...
  return (
    <div className="container">
      <h2 className="mt-4 mb-3" style={{textAlign:'center',color:'red'}}>Expense Tracker</h2>
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="btn btn-primary" style={{}}>Add Expense</button>
        
      </form>
      
      <div className='contain'>
      <form style={{float:'left',marginLeft:'650px',paddingTop:'10px'}}>
      ...
      <div style={{float:'left', marginLeft:'600px'}}>
        <h3 className="mt-3">Total Savings</h3>
